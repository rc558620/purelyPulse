...
export const pages = {
  ...
  profile:          lazyWithPreload(() => import('../pages/profile/profile')),
  changePassword:   lazyWithPreload(() => import('../pages/changePassword/changePassword')),
  changeNickname:   lazyWithPreload(() => import('../pages/changeNickname/changeNickname')),
